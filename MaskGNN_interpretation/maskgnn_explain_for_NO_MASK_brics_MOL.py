...
def maskgnn_model_explain_for_no_mask(seed, task_name, model_name, rgcn_hidden_feats=[64, 64, 64], ffn_hidden_feats=128,
    ...
    try:
        stop_test_list, _ = run_an_eval_epoch(args, model, test_loader, loss_criterion,
                                              out_path='../prediction/brics_mol/' + args[
...
# Mutagenicity
task_name = 'Mutagenicity_6_brics_mol'
...
hyperparameter = {'rgcn_hidden_feats':[[64, 64, 64], [128, 128, 128], [256, 256, 256], [128, 128], [64, 64, 64]], 'ffn_hidden_feats':[128, 128, 128, 128, 128],
                ...
                'classification':True}
for i in range(5):
    maskgnn_model_explain_for_no_mask(seed=i, task_name=task_name, model_name=model_name, rgcn_hidden_feats=hyperparameter['rgcn_hidden_feats'][i],
                                     ffn_hidden_feats=hyperparameter['ffn_hidden_feats'][i],
                                     lr=hyperparameter['lr'][i], classification=hyperparameter['classification'])


# task_name = 'ESOL_6_brics_mol'
# model_name = 'ESOL'
