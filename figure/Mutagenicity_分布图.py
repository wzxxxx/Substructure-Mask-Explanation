...
for task_name in ['Mutagenicity_top20', 'Mutagenicity']:
        ...
        plt.legend(labels=['Mutag-toxic BRICS fragments','Non-Mutag-toxic BRICS fragments'], loc='upper right')
        plt.subplots_adjust(bottom=0.1)

        font2 = {'weight' : 'normal',
                'size'   : 15,
                }
        plt.xlabel('Prediction of the Mutagenicity model'.format(task_name), font2)
        plt.ylabel('', font2)
